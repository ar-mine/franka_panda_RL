...
//  planning_components->setStartStateToCurrentState();
  ...
  auto total = plan_solution1.trajectory->getWayPointCount();
  RCLCPP_INFO(LOGGER, "Total time: %.4f", plan_solution1.trajectory->getDuration());
//  for (size_t i=0; i<total; i++){
//      RCLCPP_INFO_STREAM(LOGGER, "The"<< i <<" th point:");
//      plan_solution1.trajectory->getWayPoint(i).printStatePositions();
//  }
