...
MoveitBase::MoveitBase(const std::string& node_name, const rclcpp::NodeOptions& node_options, int mode)
...
void MoveitBase::target_pose_callback(const geometry_msgs::msg::PoseStamped::ConstSharedPtr msg)
{
...
void MoveitBase::target_joints_callback(const std_msgs::msg::Float64MultiArray::ConstSharedPtr msg)
{
    // Return if target pose is unchanged
...
bool MoveitBase::moveit_move_ready(const rclcpp::Logger& LOGGER)
{
...
void MoveitBase::hand_action(bool open_close, const rclcpp::Logger& LOGGER)
{
...
void MoveitBase::result_callback(const GoalHandleGrasp::WrappedResult & result)
{
    switch (result.code) {
